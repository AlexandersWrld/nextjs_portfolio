  ...
  return (
    <div className="h-screen bg-primary-1">
      <main className="space-y-16 px-4">
        <div className="w-full flex items-center justify-end px-8 h-[60vh] bg-outlaw">
        ...
        <p className="text-3xl text-primary-2 max-w-8xl"> I got my start as a graphic designer. I was fresh out of highschool back in Jamaica, with little idea about what I wanted to do next.
          ...
          <p className="text-3xl text-primary-2 max-w-8xl">
